...
// node_modules/react-daypicker/lib/DayPicker.js
var require_DayPicker = __commonJS({
  "node_modules/react-daypicker/lib/DayPicker.js"(exports) {
    ...
    var DayPicker = function(_Component) {
      _inherits(DayPicker2, _Component);
      function DayPicker2(props) {
        var _this;
        _classCallCheck(this, DayPicker2);
        _this = _possibleConstructorReturn(this, _getPrototypeOf(DayPicker2).call(this, props));
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "previousMonth", function() {
          var _this$state = _this.state, month = _this$state.month, year = _this$state.year;
          _this.setState({
        ...
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderDay", function(day, index) {
          var _this$state3 = _this.state, date = _this$state3.date, month = _this$state3.month, today = _this$state3.today, year = _this$state3.year;
          var active = _this.props.active;
          var isToday = day && day.valueOf() === today.valueOf();
          var isActive = active && day && DayPicker2.isSameDay(active, day);
        ...
        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderWeek", function(days, index) {
          var _this$state4 = _this.state, month = _this$state4.month, year = _this$state4.year;
      ...
      _createClass(DayPicker2, [{
        ...
        value: function render() {
          var _this$state5 = this.state, month = _this$state5.month, year = _this$state5.year;
        ...
        key: "days",
        get: function get() {
          var _this$state6 = this.state, month = _this$state6.month, year = _this$state6.year;
...
export default require_DayPicker();
//# sourceMappingURL=react-daypicker.js.map
