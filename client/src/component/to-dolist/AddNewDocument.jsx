...
function AddNewDocument({ id, onSubmitDocument, show, handleShow, title }) {
  const [selectedTitle, setSelectedTitle] = useState(null);
  const [selectedDescription, setSelectedDescription] = useState(null);
  const [selectedFile, setSelectedFile] = useState(null);

  const closeModalDocument = (isActive) => {
    if (!isActive) {
  ...
  return (
    <div
      ...
      aria-modal={show}
      role="dialog"
      onClick={(e) => e.target.attributes.role && closeModalDocument(false)}
    >
              ...
              <div className="row">
                <div className="col-12">
                  <div className="crancy-main-form__top">
                    <h4 className="crancy-main-form__title">{title}</h4>
                    <div
                      className="crancy-main-form__right"
                      onClick={() => closeModalDocument(false)}
                    >
                      <a
