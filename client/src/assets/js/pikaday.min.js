...
!(function (e, t) {
  ...
  var t = "function" == typeof e,
    ...
    w = function (e) {
      ...
      return (
        ...
        '<td data-day="' +
          ...
          '" aria-selected="' +
          n +
          '"><button className="pika-button pika-day" type="button" data-pika-year="' +
          e.year +
          '" data-pika-month="' +
          e.month +
          '" data-pika-day="' +
    ...
    x = function (e, t, n, a, i, s) {
      var o,
        ...
        m =
          '<div id="' +
          s +
          '" className="pika-title" role="heading" aria-live="assertive">',
        p = !0,
        y = !0;
      for (l = [], o = 0; o < 12; o++)
        l.push(
      ...
      for (
        h =
          ...
          c.i18n.months[a] +
          '<select className="pika-select pika-select-month" tabindex="-1">' +
          l.join("") +
          "</select></div>",
          d(c.yearRange)
      ...
      return (
        (u =
          ...
          n +
          c.yearSuffix +
          '<select className="pika-select pika-select-year" tabindex="-1">' +
          l.join("") +
          "</select></div>"),
    ...
    R = function (e, t, n) {
      return (
        '<table cellpadding="0" cellspacing="0" className="pika-table" role="grid" aria-labelledby="' +
        n +
        '">' +
        (function (e) {
          var t,
    ...
    N = function (o) {
      ...
      (l._onMouseDown = function (e) {
        ...
        (l._onChange = function (e) {
          var t = (e = e || window.event).target || e.srcElement;
          t &&
            (r(t, "pika-select-month")
              ? l.gotoMonth(t.value)
              : r(t, "pika-select-year") && l.gotoYear(t.value));
        }),
        ...
        h.field &&
          (h.container
            ? h.container.appendChild(l.el)
            : h.bound
            ? a.body.appendChild(l.el)
            : h.field.parentNode.insertBefore(l.el, h.field.nextSibling),
          s(h.field, "change", l._onInputChange),
          h.defaultDate ||
            ((h.defaultDate = l._parseFieldValue()), (h.setDefaultDate = !0)));
      var d = h.defaultDate;
      u(d)
        ? h.setDefaultDate
          ? l.setDate(d, !0)
        ...
        h.bound
          ? (this.hide(),
            ...
            s(h.trigger, "click", l._onInputClick),
            s(h.trigger, "focus", l._onInputFocus),
            s(h.trigger, "blur", l._onInputBlur))
          : this.show();
    };
  return (
    (N.prototype = {
      config: function (e) {
        ...
        if (
          ...
          (t.yearRange = Math.abs(parseInt(t.yearRange, 10)) || v.yearRange),
      ...
      adjustPosition: function () {
        ...
        if (!this._o.container) {
          if (
            ...
            (d = (c = e.getBoundingClientRect()).left + window.pageXOffset),
              (u = c.bottom + window.pageYOffset);
          else
            for (
              d = t.offsetLeft, u = t.offsetTop + t.offsetHeight;
              (t = t.offsetParent);

            )
              (d += t.offsetLeft), (u += t.offsetTop);
          ((this._o.reposition && d + n > s) ||
            (this._o.position.indexOf("right") > -1 &&
              d - n + e.offsetWidth > 0)) &&
            ((d = d - n + e.offsetWidth), (f = !1)),
            ((this._o.reposition && u + i > o + r) ||
              (this._o.position.indexOf("top") > -1 &&
                u - i - e.offsetHeight > 0)) &&
              ((u = u - i - e.offsetHeight), (g = !1)),
      ...
      render: function (e, t, n) {
        ...
        for (var _ = !1, x = 0, N = 0; x < b; x++) {
          var S = new Date(e, t, x - o + 1),
            ...
            A =
              a.startRange && a.endRange && a.startRange < S && S < a.endRange;
          Y &&
            (x < o
              ? ((E = D + E), (O = h), (j = f))
              : ((E -= s), (O = d), (j = y)));
          var L = {
            ...
            isToday: I,
            isDisabled:
              (a.minDate && S < a.minDate) ||
              (a.maxDate && S > a.maxDate) ||
              (a.disableWeekends && c(S)) ||
              (a.disableDayFn && a.disableDayFn(S)),
            isEmpty: Y,
            isStartRange: W,
            isEndRange: F,
            isInRange: A,
          ...
          a.pickWholeWeek && C && (_ = !0),
            ...
            7 == ++N &&
              (a.showWeekNumber &&
                l.unshift(k(x - o, t, e, a.firstWeekOfYearMinDays)),
              r.push(M(l, a.isRTL, a.pickWholeWeek, _)),
              (l = []),
              (N = 0),
              (_ = !1));
        }
